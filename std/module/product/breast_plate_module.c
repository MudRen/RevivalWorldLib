...
([
	...
	"/obj/gem/gem6" : (: addn(BUFF_HEALTH_MAX, standard_calculate($1) * 30, $2) :),
	"/quest/monster_fossil/deep_sea_thorn" : (: addn(BUFF_THORN_CHANCE, calculate_chance($1), $2) :),
]);
...
([	
	...
	//材料需求
	"material":	([ "steel":20, "/obj/pasture/product/leather":4, "mold":6, "man_made_fibers":10 ]),

	//技能需求
	"skill":	([ "armor-fac":90, "technology":90 ]),

...
([
	...
	"/quest/monster_fossil/eye_claw" : (: addn(BUFF_COUNTERATTACK_CHANCE, calculate_chance($1), $2) :),
]);
...
([	
	...
	//材料需求
	"material":	([ "/obj/pasture/product/wool":10, "/obj/pasture/product/leather":5 ]),

	//技能需求
	"skill":	([ "clothing-fac":30, "technology":30 ]),

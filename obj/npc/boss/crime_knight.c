...
([
	10 		:	HIR"罪"NOR RED"惡"HIY"獵"NOR YEL"人"NOR,
	100		:	HIR"罪"NOR RED"惡"HIB"剋"NOR BLU"星"NOR,
	1000	:	HIR"罪"NOR RED"惡"HIR"殺"NOR RED"手"NOR,
	2000	:	HIR"罪"NOR RED"惡"HIM"噬"NOR MAG"者"NOR,
	5000	:	HIR"罪"NOR RED"惡"WHT"死"HIW"神"NOR,
]);
...
void create()
{
	set_idname(HIR"cr"NOR RED"ime "HIW"kni"NOR WHT"ght"NOR, HIR"罪"NOR RED"惡"WHT"．"HIW"騎"NOR WHT"士"NOR);

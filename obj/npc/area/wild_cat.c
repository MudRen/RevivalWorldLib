...
([
	500 	:	"野貓"HIY"獵"NOR YEL"人"NOR,
	5000	:	"野貓"HIB"剋"NOR BLU"星"NOR,
	50000	:	"野貓"HIR"殺"NOR RED"手"NOR,
	200000	:	"野貓"HIM"噬"NOR MAG"者"NOR,
	500000	:	"野貓"WHT"死"HIW"神"NOR,
]);
...
void reply_defeat(object* attackers)
{
	...
	{
		object ob = new("/quest/monster_fossil/cat_fossil");
		ob->move(this_object());
	}
...
void create()
{
	...
	set("abi/stamina/max", 150);
	set("abi/stamina/cur", 150);
	set("abi/health/max", 150);
	set("abi/health/cur", 150);
	set("abi/energy/max", 150);
	set("abi/energy/cur", 150);

	set("skills/unarmed/level", 15);
	set("skills/dodge/level", 15);
	
	set("long", "　一隻渾身髒亂又兇惡的野貓。");

	if( !random(1000) )
	{
		set_idname(HIY"wild"NOR YEL" cat"NOR, HIY"野"NOR YEL"貓"NOR);

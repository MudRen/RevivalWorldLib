...
([
	500 	:	"野豹"HIY"獵"NOR YEL"人"NOR,
	5000	:	"野豹"HIB"剋"NOR BLU"星"NOR,
	50000	:	"野豹"HIR"殺"NOR RED"手"NOR,
	200000	:	"野豹"HIM"噬"NOR MAG"者"NOR,
	500000	:	"野豹"WHT"死"HIW"神"NOR,
]);
...
void reply_defeat(object* attackers)
{
	...
	{
		object ob = new("/quest/monster_fossil/panther_fossil");
		ob->move(this_object());
	}
...
void create()
{
	...
	set("abi/stamina/max", 300);
	set("abi/stamina/cur", 300);
	set("abi/health/max", 300);
	set("abi/health/cur", 300);
	set("abi/energy/max", 300);
	set("abi/energy/cur", 300);

	set("skills/unarmed/level", 30);
	set("skills/dodge/level", 30);
	
	set("long", "　一隻渾身髒亂又兇惡的野豹。");
	
	if( !random(1000) )
	{
		set_idname(HIY"wild"NOR YEL" panther"NOR, HIY"野"NOR YEL"豹"NOR);

...
([
	500 	:	"野豬"HIY"獵"NOR YEL"人"NOR,
	5000	:	"野豬"HIB"剋"NOR BLU"星"NOR,
	50000	:	"野豬"HIR"殺"NOR RED"手"NOR,
	200000	:	"野豬"HIM"噬"NOR MAG"者"NOR,
	500000	:	"野豬"WHT"死"HIW"神"NOR,
]);
...
void create()
{
	...
	set("long", "　一隻渾身髒亂又兇惡的野豬。");

	if( !random(1000) )
	{
		set_idname(HIY"wild"NOR YEL" pig"NOR, HIY"野"NOR YEL"豬"NOR);

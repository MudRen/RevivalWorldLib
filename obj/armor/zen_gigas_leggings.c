...
void create()
{
	set_idname(HIW"zen "NOR HIR"gigas "NOR RED"leggings"NOR, HIW"ÁI"NOR WHT"¡D"NOR HIR"¨ªø¿"NOR RED"»L¥Ò"NOR);
	set_temp("status", HIW"¥v"NOR WHT"¸Ö");

	if( this_object()->set_shadow_ob() ) return;
	
	set("long", "¤@°Æ±q¨ªø¿Àt¤W±¼¸¨ªº¥v¸Ö»L¥Ò¡C\n");
	set("unit", "°Æ");
	set("mass", 500);
	set("value", 10000);

 ...
 * See /doc/help/copyright for more info
 -----------------------------------------
 * File   : zen_nessiteras_leggings.c
...
void create()
{
	set_idname(HIW"zen "NOR HIB"nessiteras"NOR MAG" leggings"NOR, HIW"ÁI"NOR WHT"¡D"NOR HIB"¥§´µ"NOR MAG"»L¥Ò"NOR);
	set_temp("status", HIW"¥v"NOR WHT"¸Ö");

	if( this_object()->set_shadow_ob() ) return;
	
	set("long", "¤@°Æ±q¥§´µ´ò¤ô©Ç¤W±¼¸¨ªº¥v¸Ö»L¥Ò¡C\n");
	set("unit", "°Æ");
	set("mass", 500);
	set("value", 10000);

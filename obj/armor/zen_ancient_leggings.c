...
void create()
{
	set_idname(HIW"zen "NOR HIM"ancient"NOR MAG" leggings"NOR, HIW"ÁI"NOR WHT"¡D"NOR HIM"»·¥j"NOR MAG"»L¥Ò"NOR);
	set_temp("status", HIW"¥v"NOR WHT"¸Ö");

	if( this_object()->set_shadow_ob() ) return;
	
	set("long", "¤@°Æ±q³Q¿ò§Ñªº»·¥jªZ¤h¤W±¼¸¨ªº¥v¸Ö»L¥Ò¡C\n");
	set("unit", "°Æ");
	set("mass", 500);
	set("value", 10000);

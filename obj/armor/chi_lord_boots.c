...
void create()
{
	set_idname(HIW"chi "NOR HIY"lord"NOR YEL" boots"NOR, HIW"極"NOR WHT"．"NOR HIY"王"NOR YEL"者"HIY"鞋"NOR YEL"子"NOR);
	set_temp("status", HIW"史"NOR WHT"詩");

	if( this_object()->set_shadow_ob() ) return;
	
	set("long", "一副古代文字中記載的史詩鞋子。\n");
	set("unit", "副");
	set("mass", 500);
	set("value", 10000);
	...
	set("disassemble", ([ "/obj/gem/gem5" : 15 ]));

...
mapping quests = ([
	...
	QUEST_LOST_SHARD		: ({ QUEST_LOST_SHARD_NAME, QUEST_LOST_SHARD_STEP, 1 }),
	...
	QUEST_MOON_RABBIT		: ({ QUEST_MOON_RABBIT_NAME, QUEST_MOON_RABBIT_STEP, 0 }),
	QUEST_FOSSIL			: ({ QUEST_FOSSIL_NAME, QUEST_FOSSIL_STEP, 1 }),
]);

...
TEXT);
	...
	set("exits", ([ 
		"out" : ({ 69, 70, 0, "atlantis", 9, 0, "69/70/0/atlantis/9/0" }),
		"down" : "/quest/godsland/room_godsland_2",		
	 ]));
...
void do_push(object me, string arg)
{
	...
	else
	{
		...
		set_temp("godsland_enter", quest + ({ 1 }), me);
	}
}

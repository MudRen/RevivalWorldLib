...
TEXT);
	...
	set("exits", ([ 
		"west" : "/quest/godsland/room_godsland_2",
		"north" : "/quest/godsland/room_godsland_4",
	 ]));
...
void do_push(object me, string arg)
{
	...
	else
	{
		...
		set_temp("godsland_enter", quest + ({ 3 }), me);
	}
}
